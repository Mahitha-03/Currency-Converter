...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtFrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "PHP","INR","AUD" }));
        txtFrom.setToolTipText("");

        txtTo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PHP", "USD","INR","AUD" }));
    ...
    private void ConvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConvertActionPerformed
        ...
        else if(txtFrom.getSelectedItem().toString().equals("USD") && txtTo.getSelectedItem().toString().equals("INR")){
    convert = amount * 83;
    JOptionPane.showMessageDialog(this, "The amount is: " + convert + " INR");
}
else if(txtFrom.getSelectedItem().toString().equals("INR") && txtTo.getSelectedItem().toString().equals("USD")){
    convert = amount * 0.012;
    JOptionPane.showMessageDialog(this, "The amount is: " + convert + " USD");
}
else if(txtFrom.getSelectedItem().toString().equals("USD") && txtTo.getSelectedItem().toString().equals("AUD")){
    convert = amount * 1.5;
    JOptionPane.showMessageDialog(this, "The amount is: " + convert + " AUD");
}
else if(txtFrom.getSelectedItem().toString().equals("AUD") && txtTo.getSelectedItem().toString().equals("USD")){
    convert = amount * 0.67;
    JOptionPane.showMessageDialog(this, "The amount is: " + convert + " USD");
}
